...
void loop() {
  ...
  switch (etat) {
    case 0:     // Arrêt
      ...
      if (digitalRead(BTN_FERM_PIN) == HIGH) {    // Si appui sur bouton fermeture
    ...
    case 1:     // Ouverture
      ...
      if ((digitalRead(BTN_OUV_PIN) == HIGH) || (digitalRead(BTN_FERM_PIN) == HIGH)
          || (digitalRead(FDC_OUV_PIN) == HIGH)) {
